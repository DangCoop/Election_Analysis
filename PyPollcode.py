...
file_to_save = '/Users/dang/Desktop/Analysis Projects/Election_Analysis/analysis/election_analysis.txt' #os.path.join("analysis", "election_analysis.txt")
         ...
         # 2. Add to the total vote count.
          ...
          # Print the candidate name from each row.
            ...
            if candidate_name not in candidate_options:
                ...
                # 2. Beginig tracking that candidate's vote count.
  ...
  # Print the final vote count to the terminal.
    ...
    for candidate_name in candidate_votes:
            ...
            votes_percentage = float(votes) / float(total_votes)*100  
                # 4. Print the candidate name and percentage votes, (:.2f format to hundred)  
